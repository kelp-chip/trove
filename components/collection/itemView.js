...
export default function ItemView({ items, name, selectedItem }) {
  ...
  const imageUrl = selectedItem.images || 'https://st4.depositphotos.com/14953852/24787/v/600/depositphotos_247872612-stock-illustration-no-image-available-icon-vector.jpg';
